...
def create_file():
    ...
    if request.files['pic'].filename != "":
        ...
        files["dotastro{}/{}".format(meeting_number, image_filename)] = content, 'base64'
    ...
    files['dotastro{}/{}'.format(meeting_number, filename)] = make_file_contents(request, image_filename), 'utf-8'
    ...
    prbody = 'This is a PR auto-generated by a form to record information about the dotAstronomy {} hack "{}"'.format(meeting_number, request.form['title'])
